...
public class CheckInByBarcodeResource extends Resource {
  ...
  private void checkin(RoutingContext routingContext) {
    ...
    loanCheckInService.checkIn(checkInRequestResult, loanRepository)
      ...
      //Second loan update needed in order to update the item status
      // (may create second action history entry)
